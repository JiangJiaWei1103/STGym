...
class DGCRN(nn.Module):
    ...
    Parameters:
        ...
        rnn_size: hidden dimension of rnn
        ...
        list_weight: weight of different grpah convolution components
        node_dim: dimension of node embedding for graph generator
        middle_dim: hidden dimension of hyper-network
        hyperGNN_dim: hidden dimension of hyper-network
        ...
        **kwargs: Any,
        ...
        for i in range(task_level):
            ...
            if self.training and self.use_curriculum_learning:
                ...
                if c < self._compute_sampling_threshold(iteration):
...
class _GCN(nn.Module):
    ...
    Parameters:
        ...
        dropout:  dropout ratio
        alpha: weight of input components
        beta: weight of dynamic graph convolution components
        gamma: weight of static graph convolution components
