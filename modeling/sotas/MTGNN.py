...
class MTGNN(nn.Module):
    ...
    Parameters:
        layers: number of MTGNN layers
        dropout: dropout ratio
        layer_norm_affline: whether to use layer norm
        gcn_true: whether to use graph convolution
        ...
        kernel_set: list of kernel size
        buildA_true: whether to construct adjacency matrix by Graph learning layer
        subgraph_size: select how many top closest neighbors in adjacency matrix
        node_dim: dimension of node embedding
        tanhalpha: controlling the saturation rate of the activation function
        conv_channels: output dimension of temporal convolution layer
        residual_channels: output dimension of residual layer
        skip_channels: output dimension of skip connection
        end_channels: hidden dimension of output layer
    ...
    def forward(self,
        ...
        **kwargs: Any,
        ...
        Shape:
            ...
            output: (B, Q, N)
        """
        input = input.permute(0, 3, 2, 1)   # (B, C, N, P)
...
class _GraphLearning(nn.Module):
    ...
    Parameters:
        ...
        static_dim: dimension of static node features
    """
    ...
    def forward(self, idx: Tensor, static_feature: Optional[Tensor] = None) -> Tensor:
        """
        Foward pass.
        ...
        if static_feature is None:
            ...
            nodevec1 = nodevec2 = static_feature[idx,:]
